...
public class ScreenDialog extends JDialog implements DocumentListener {
    ...
    public ScreenDialog() {
        super(null, "Screen Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    ScreenDialog(ProjectOrganization organization) {
        super(null, "Screen Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
